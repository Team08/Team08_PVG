...
public class TestReadFile extends Sorter {
	...
	public TestReadFile() {
		super("TestStart.test", "TestStart.test", "",1,0,0, 0);
		 startfFile = new ReadStartFile(new Sorter("TestStart.test", "TestStart.test", "",1,0,0, 0), "TestStart.test");
		 finishFile = new ReadFinishFile(new Sorter("TestStart.test", "TestStart.test", "",1,0,0, 0), "TestStart.test");
	}
