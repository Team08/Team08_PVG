	...
	public static void main(String[] args) {
		...
		public void testExpResultWithsortedResult(){
			...
			while( (line = br.readLine()) != null && (line2 = br2.readLine()) != null) {
				...
				assertTrue("sortedfilens inneh�ll st�mmer inte med expResult" , line.equals(line2));
			}
		...
		// J�mf�r "sortedResult.txt med expResult2
		// Skillnaden mellan result1 och 2 �r att raceTime ="10.00" (hh.mm)
		...
		public void testExpResultWithsortedResult2(){
			...
			while( (line = br.readLine()) != null && (line2 = br2.readLine()) != null) {
				System.out.println(line);
				System.out.println(line2);
				assertTrue("sortedfilens inneh�ll st�mmer inte med expResult2" , line.equals(line2));
			}
